...
public class EditProfileImage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean flag = dao.updateUserProfile(currentUser);
            
            if(flag) {
                String newProfileLocation = request.getRealPath("/")+"pics"+ File.separator +currentUser.getProfile();
                
                if(!oldProfile.equals("default.jpg")) {
                    String oldProfileLocation = request.getRealPath("/")+"pics"+ File.separator +oldProfile;
                    Helper.deleteFile(oldProfileLocation);
                }
                
                if(Helper.saveFile(part.getInputStream(), newProfileLocation)) {
